...
insert into author (age, name, genre, best_selling, id) values (34, 'Joana Nimar', 'History', 'Yes', 4);
insert into author (age, name, genre, best_selling, id) values (38, 'Alicia Tom', 'Anthology', 'No', 5);
insert into author (age, name, genre, best_selling, id) values (56, 'Katy Loin', 'Anthology', 'No', 6);
